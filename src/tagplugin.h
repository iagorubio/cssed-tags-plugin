...
#define TAG_PLUGIN(n) (CssedTagPlugin*) n

typedef struct _CssedTagPlugin {
	CssedPlugin* plugin;
	GtkWidget* user_interface;
	GtkWidget* popmenu_item;
	GtkWidget* entry_current_tag_file;
	GtkWidget* entry_tag_query;
	GtkWidget* checkbutton_partial_match;
	GtkWidget* radiobutton_case_sensitive;
	GtkWidget* radiobutton_case_insensitive;
